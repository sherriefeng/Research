...
ofile = csv.writer(open("../../data/data_small_world_s2_without_storage_item3.csv", "w"))
#ofile = csv.writer(open("../../data/data_small_world_s2_without_storage_item2.csv", "w"))
#ofile = csv.writer(open("../../data/data_small_world_s2_without_storage_item4.csv", "w"))
#ofile = csv.writer(open("../../data/data_small_world_s2_with_storage_item3.csv", "w"))
...
for k in range(500):
    ...
    filename = '../../data/networks/sw_shortcut2/sw_shortcut2_2_' + str(k) +'.edgelist'
